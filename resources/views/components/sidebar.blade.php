            ...
            <ul class="sidebar-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="nav-link" href="/school">School setup</a></li>
                        <li><a class="nav-link" href="/post">Posts</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="menu-toggle nav-link has-dropdown"><i
                            data-feather="command"></i><span>Applications</span></a>
                    <ul class="dropdown-menu">
                        <li><a class="nav-link" href="chat.html">Online Applications</a></li>
                        <li><a class="nav-link" href="portfolio.html">Student enquiry</a></li>
                ...
                <li class="dropdown">
                    <a href="/subject" class="nav-link"><i data-feather="monitor"></i><span>Subject</span></a>
                </li>
                <li class="dropdown">
                    <a href="#" class="menu-toggle nav-link has-dropdown"><i
