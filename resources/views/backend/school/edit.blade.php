                ...
                <div class="card-body">
                    ...
                    <form action="/school" , method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="Enter your name" value="{{ $school->name }}">
                        </div>

                        <div class="form-group">
                            <label for="address">Address <span class="text-danger">*</span></label>
                            <input type="text" name="address" id="address" class="form-control"
                                placeholder="Enter your address" value="{{ $school->address }}">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact" id="contact" class="form-control"
                                        placeholder="Enter your number" value="{{ $school->contact }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" id="email" class="form-control"
                                        placeholder="Enter your email" value="{{ $school->email }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="slogan" id="slogan" class="form-control"
                                placeholder="Enter your slogan" value="{{ $school->slogan }}">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Youtube" id="Youtube" class="form-control"
                                        placeholder="Enter your Youtube" value="{{ $school->youtube }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="instagram" id="instagram" class="form-control"
                                        placeholder="Enter your instagram" value="{{ $school->instagram }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="linkedin" id="linkedin" class="form-control"
                                        placeholder="Enter your Linkedin" value="{{ $school->linkedin }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="facebook" id="facebook" class="form-control"
                                        placeholder="Enter your facebook" value="{{ $school->facebook }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
